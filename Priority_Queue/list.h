...
typedef enum {high, normal, low, initial, highblock, normalblock, lowblock, semhighblock, semnormalblock, semlowblock} qtype;

typedef struct{
    int ID; /* id of the process */
    qtype queue; /* what priority is the process */
    int commsid; /* The id of the process in communication */
    char* sendmes; /* The message*/
    char* recvmes; /* The received message */
    int semaph; 
}Process; 
